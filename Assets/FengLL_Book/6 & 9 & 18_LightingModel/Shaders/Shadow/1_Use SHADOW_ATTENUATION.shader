...
Shader "FengLL_Book/Chapter6 & 9 & 18/9_Use SHADOW_ATTENUATION"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 color_FinalRGB = (ambient + ((diffuse + specular) * shadow) * atten);
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 color_FinalRGB = ((diffuse + specular) * shadow) * atten;
                return fixed4(color_FinalRGB, 1);
            }
            ENDCG
        }
