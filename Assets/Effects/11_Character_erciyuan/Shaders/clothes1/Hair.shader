    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                half4 specular_Map = tex2D(_SpecularMap, i.uv);
                half specular_Mask = specular_Map.a;
                half specular_Smoothness = specular_Map.a;
                ...
                //half specular_Term = pow(max(0.0001, sinTH), _Specular_Smoothness);
                half specular_Term = max(0.0001, pow(sinTH, _Specular_Smoothness));
                half3 final_Specular = specular_Term * _Specular_Intensity * _Specular_Color.rgb * specular_Smoothness;
