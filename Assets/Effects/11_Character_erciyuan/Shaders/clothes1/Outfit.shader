    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                half specular_Mask = specular_Map.b;
                ...
                half specular_Term = max(0.0001, pow(NdotH, _Specular_Smoothness * specular_Smoothness * 5)) * AO;
                half3 final_Specular = specular_Term * specular_Mask * _Specular_Intensity * _Specular_Color.rgb;
